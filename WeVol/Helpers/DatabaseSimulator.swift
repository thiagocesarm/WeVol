...
class DatabaseSimulator {
    static func getInstitutionData() -> [Institution] {
        ...
        institutions.append(Institution(image: "img01", name: "Mãos Amigas", category: "Projetos sociais", detailedInfo: "A motivação inicial para o presente trabalho ocorreu através de um tema pré-estabelecido, a concepção de soluções computacionais que pudessem auxiliar pessoas em situação de vulnerabilidade. Com esse tema em mente, a etapa seguinte foi pensar em um problema de vulnerabilidade humana que pudesse ser amenizado ou solucionado por meio de tec- nologia.", opportunityList: opportunityList, bankAccountList: bankAccountList, jobTypesList: [.eventParticipation, .manualLabor], distance: 0.3))
        institutions.append(Institution(image: "img02", name: "Grupo de Apoio Jovem", category: "Educação e cultura", detailedInfo: "Lorem ipsum dolor sit amet", opportunityList: opportunityList, bankAccountList: bankAccountList, jobTypesList: [.eventParticipation, .peopleCaring], distance: 0.9))
        institutions.append(Institution(image: "img03", name: "Instituto Reciclare", category: "Meio ambiente e sustentabilidade", detailedInfo: "Lorem ipsum dolor sit amet", opportunityList: opportunityList, bankAccountList: bankAccountList, jobTypesList: [.technicalLabor, .manualLabor], distance: 2.4))
        return institutions
    }
